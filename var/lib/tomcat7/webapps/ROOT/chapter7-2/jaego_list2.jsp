...
<%		double total =0;
		...
		ResultSet rset = stmt.executeQuery("select* from jaego order by id desc;");
		int startpage=0;
		int max = 0;
		int maxx=0;
		int LineCnt=1;
...
%>	
		...
		<td width=100><p align=center> <%out.println(rset.getDate(4));%></p></td>
		<td width=100><p align=center> <%out.println(rset.getDate(5));%></p></td> 
		</tr>
<%			LineCnt++;
		}
