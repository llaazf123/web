...
<table border=1 align=center>
	<tr>
		<td align=center colspan = "2">(주)트와이스 재고 현황 - 상품수정</td>
	</tr>
<form>		
	<tr>
	...
	<tr>
		...
		<td>
			<input type = "text" value = "<%=number%>" name="number" maxlength="3">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<input type = "submit" value = "재고수정" formaction="jaego_update.jsp">
		</td>	
	</tr>
</form>	
</table>
