...
//마치 브라우져로 조회하여 세션이 유지되는 효과를 얻게 하는 함수
...
public String goLogin(){
	return goXML("http://192.168.56.102:8080/2chapter3/login.jsp", true);
}
...
<%
	...
	String ret=goLogin();
	ret=goXML("http://192.168.56.102:8080/2chapter3/loginxml.jsp");
	try{
