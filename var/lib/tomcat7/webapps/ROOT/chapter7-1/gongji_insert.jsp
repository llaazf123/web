...
<%
		...
		stmt.execute("insert into gongji (title, date, content, viewcnt, relevel, recnt, rootid, picture) values ('" + title + "','" + date + "','" + content + "', 0, " + relevel 
		...
		stmt.execute("update gongji set rootid=" + rootid + " where id =" + rootid + ";");
