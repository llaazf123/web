...
<%
	...
	String loginOK=null;
	String jumpURL="?contentPage=adm_login.jsp?jump=?contentPage=adm_logintest.jsp";
	
	loginOK = (String)session.getAttribute("login_ok");
	
	//맨 처음 로그인이 되지 않았을 시, jumpURL을 가지고 adm_login.jsp로 이동
	if(loginOK==null){
	...
	//로그인이 되었을 시 아래 body 부분을 전체 출력, body부분은 d_list와 동일.
	else{
	}
	%>
</head>
