...
<table border=1 align=center>
	...
	<tr>
		<%if(type==1){%>
		<td colspan="2" align=right><input type = "submit" value = "목록" formaction="?contentPage=e_01_list.jsp">
		<input type = "submit" value = "수정" formaction="?contentPage=e_beforeupdate.jsp">
		<input type = "submit" value = "삭제" formaction="?contentPage=e_delete.jsp"></td>	
		<%}else{%>
		<td colspan="2" align=right><input type = "submit" value = "목록" formaction="?contentPage=e_02_list.jsp">
		<input type = "submit" value = "수정" formaction="?contentPage=e_beforeupdate.jsp">
		<input type = "submit" value = "삭제" formaction="?contentPage=e_delete.jsp">
		<input type = "submit" value = "댓글" formaction="?contentPage=e_02_rewrite.jsp"></td>	
		<%}%>
	</tr>
</table>
</form>
