...
<%
		...
		stmt.execute("insert into resort (title, date, content, viewcnt, relevel, recnt, rootid, picture, type) values ('" + title + "','" + date + "','" + content + "', 0, " + relevel 
		+ ", " + recnt + ", " + rootid + ", '" + picture + "', " + type + ");");
...
<form method="post">
<%if(type==1){%>
<input type ="submit" value = "목록" formaction = "?contentPage=e_01_list.jsp">
<%}else{%>
